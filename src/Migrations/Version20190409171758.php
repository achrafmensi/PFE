 ...
 */
final class Version20190409171758 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tache ADD client_id INT DEFAULT NULL, ADD description VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tache DROP client_id, DROP description');
    }
}
